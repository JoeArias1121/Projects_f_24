...
<div class="w3-center w3-padding">
    ...
    <table id="workflowTable" class="pagination w3-table-all w3-responsive w3-content" data-pagecount="8" style="max-width:fit-content;">
        <tr>
            <th>Form Title</th>
            <th>Responsible</th>
            <!--<th>Deadline</th>
        ...
        <tr>
            ...
            <td>
                <form method="post" action="./dashboard.php?content=forms&contentType=removeForm">
                    ...
                    <button type="submit" name="viewForm" class="w3-button w3-red w3-round-large">REMOVE</button>
                </form>
            </td>
        </tr>
        <?php } ?>
