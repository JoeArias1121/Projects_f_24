      ...
      if ($_GET['content'] == "jobs" || $_GET['content'] == "home" || 
          ...
          $_GET['content'] == "jobgraph") {
            ...
            echo (
              ...
              // (Board View) 
              // (Graph View)
             '<a href="./dashboard.php?content=jobslist" style="margin-left:21%" class="w3-bar-item w3-button w3-round-xlarge w3-text-white"><b>List View</b></a>
              <a href="./dashboard.php?content=jobs" style="" class="w3-bar-item w3-button w3-round-xlarge w3-text-white"><b>Board View</b></a>
              <a href="./dashboard.php?content=jobgraph" style="" class="w3-bar-item w3-button w3-round-xlarge w3-text-white"><b>Graph View</b></a>'
            );
       }
       ...
       if ($_GET['content'] == "jobsteps" || $_GET['content'] == "jobsteplist" ||
           $_GET['content'] == "tasktemplate" || $_GET['content'] == "assigntasks") {
            ...
            echo (
              ...
              // (List View)
              // (Board View)
              '<a href="./dashboard.php?content=jobsteplist" style="margin-left:21%" class="w3-bar-item w3-button w3-round-xlarge w3-text-white"><b>List View</b></a>
        ...
        if ($_GET['content'] == "archivedjobs" || $_GET['content'] == "archivedjobslist") {
          echo (
              ...
              // (List View)
              // (Board View)
            '<a href="./dashboard.php?content=archivedjobslist" style="margin-left:21%" class="w3-bar-item w3-button w3-round-xlarge w3-text-white"><b>List View</b></a>
...
<?php 
    ...
    <div class="w3-bar-item w3-button w3-hover-shadow w3-round-xlarge w3-blue" style="margin-left:21%"
         onclick="enableView()">
      <b>View Data</b>
    </div>
    <div class="w3-bar-item w3-button w3-hover-shadow w3-round-xlarge w3-green" 
...
if($_GET['content'] == "search") { ?>
      ...
      <div class="w3-bar-item w3-button w3-hover-shadow w3-round-xlarge w3-blue" 
         onclick="window.location='./dashboard.php?content=search&contentType=tasks'">
        <b>Steps</b>
      </div>
      ...
      <div class="w3-bar-item w3-button w3-hover-shadow w3-round-xlarge w3-green" 
         onclick="window.location.href='./dashboard.php?content=search&contentType=department'">
        <b>Industry</b>
      </div>
      <?php }?>
...
if($_GET['content'] == "forms") {?>
      ...
      <div class="w3-bar-item w3-button w3-hover-shadow w3-round-xlarge w3-orange w3-text-white" style="margin-left:21%"
...
<?php if(($_GET['content'] == "messages") || ($_GET['content'] == "allmessages") || 
    ($_GET['content'] == "deleted") || ($_GET['content'] == "sentmessages") || ($_GET['content'] == "archived") ||
    (($_GET['content'] == "create") && $_GET['contentType'] == "message")){ 

        if($_SESSION['user_type'] == 1) { 
            $thisUser = $_SESSION['user_id'];
    ?> 
            <div class="w3-bar-item w3-button w3-hover-shadow w3-round-xlarge w3-amber w3-text-white" style="margin-left:21%"
...
<!-- Notice the div id is "id05" this is what is called in line "215" of this doc -->
