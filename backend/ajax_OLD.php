<?php
    ...
    function delete() //delete function for message
    {
        ...
        $user = 'p_f22_03';
        $pass = 'dtn4x0';
        $db = 'p_f22_03_db'; //creating these new connections each function could have been avoided with a database connection object, this was easiest way with the timeline to get ajax done
